...
RSpec.configure do |config|
  ...
  config.global_fixtures = :client_applications, :comments, :communications, :conversations, :feeds, :forums, :neighborhoods, :oauth_nonces, :oauth_tokens, :offers, :people, :posts, :preferences, :topics
